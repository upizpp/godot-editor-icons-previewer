...
func _icon_gui_input(event, icon):
	...
	elif event is InputEventMouseMotion and event.ctrl_pressed:
...
#	yield(previews_container, 'sort_children')
	...
	$body/icons/info/icon/Export/LineEdit.clear()
	_queue_update()
...
func _on_button_pressed():
	...
	img.save_png($body/icons/info/icon/Export/LineEdit.text)

func _on_window_size_changed() -> void:
	_queue_update()

func _on_icons_dragged(offset: int) -> void:
	_queue_update()

func _on_file_dialog_file_selected(path: String) -> void:
	$body/icons/info/icon/Export/LineEdit.text = path

func _on_file_button_pressed() -> void:
	$body/icons/info/icon/Export/FileDialog.popup_centered_ratio()
